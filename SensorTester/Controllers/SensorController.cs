...
namespace SensorTester.Controllers
{
    public static class SensorController
    {
        // threading variables
        static Task? ShakeTask = null;
        static System.Timers.Timer GeolocationTimer = new System.Timers.Timer(1000);

        // state text variables
        public static string TextAccelerometer { get; private set; } = "";

        // state flag variables
        public static bool ShouldDetectShake { get; private set; } = false;

        #region Accelerometer
        private static void Accelerometer_ReadingChanged(object? sender, AccelerometerChangedEventArgs e)
        {
            Task.Run(() => {
                TextAccelerometer = "X: " + e.Reading.Acceleration.X.ToString("0.00") + "\n" +
                                         "Y: " + e.Reading.Acceleration.Y.ToString("0.00") + "\n" +
                                         "Z: " + e.Reading.Acceleration.Z.ToString("0.00") + "\n" +
                                         "Length: " + e.Reading.Acceleration.Length();// + "\n" +
                                         //"Shake Detected: " + IsShakeDetected;
            });

        }
        private static void Accelerometer_ShakeDetected(object? sender, EventArgs e)
        {
        ...
        private static void SwitchAccelerometer_Toggled(object sender, ToggledEventArgs e)
        {
        ...
        #region Barometer
        private static void Barometer_ReadingChanged(object? sender, BarometerChangedEventArgs e)
        {
            Dispatcher.Dispatch(() =>
            {
        ...
        private static void SwitchBarometer_Toggled(object sender, ToggledEventArgs e)
        {
        ...
        private static void SwitchCompass_Toggled(object sender, ToggledEventArgs e)
        {
        ...
        #region Geolocation
        private static void Geolocation_LocationChanged(object? sender, GeolocationLocationChangedEventArgs e)
        {
        ...
        private static void SwitchGeolocation_Toggled(object sender, ToggledEventArgs e)
        {
        ...
        private static void GeolocationTimer_Elapsed(object? sender, ElapsedEventArgs e1)
        {
        ...
        private static void SwitchGyroscope_Toggled(object sender, ToggledEventArgs e)
        {
        ...
        #region Magnetometer
        private static void Magnetometer_ReadingChanged(object? sender, MagnetometerChangedEventArgs e)
        {
            Dispatcher.Dispatch(() =>
            {
        ...
        private static void SwitchMagnetometer_Toggled(object sender, ToggledEventArgs e)
        {
        ...
        private static void SwitchOrientationSensor_Toggled(object sender, ToggledEventArgs e)
        {
        ...
        #region Battery
        private static void Battery_InfoChanged(object? sender, BatteryInfoChangedEventArgs e)
        {
            Dispatcher.Dispatch(() =>
            {
        ...
        private static void SwitchBatterySensor_Toggled(object sender, ToggledEventArgs e)
        {
